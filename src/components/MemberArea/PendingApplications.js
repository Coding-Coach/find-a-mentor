      ...
      <tbody>
      {
        applications.map(application =>
          <tr key={application._id}>
            <td><img alt={application.user.name} src={application.user.avatar} /></td>
            <td>{application.user.name}</td>
            <td>
              <button onClick={this.approve.bind(null, application)}>Approve</button>
              <button onClick={this.decline.bind(null, application)}>Decline</button>
            </td>
          </tr>
        )
      }
